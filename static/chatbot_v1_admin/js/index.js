...
//카테고리 불러오기
        ...
        if (response.ok) {
            ...
            for(var i=0; i<category_line_container_list.length; i++) {
                ...
                //카테고리 URL 값을 넣는다
                //getData 값을 넣는다
                category_line_container_list[i].querySelector('.category_url').value = "http://52.78.250.255/chatbot_v1/";
...
//특정 라디오 버튼 클릭시 이벤트
    ...
    document.getElementById('customRadio7').addEventListener('change', function () {
    ...
    document.getElementById('customRadio8').addEventListener('change', function () {

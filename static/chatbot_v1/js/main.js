...
async function loadCategoryList() {
    ...
    const response = await fetch("https://kms-ai.net/chatbot_v1/admin/category_list/", {
        method: "POST",
        headers: {
...
async function server_chat(userMessage) {
    ...
    const fetchMessageStream = async () => {
        ...
        const response = await fetch("https://kms-ai.net/chatbot_v1/get_message_stream/", {
            method: "POST",
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'X-CSRFToken': csrfToken
    ...
    console.log("chat_history :", chatHistory.value)
    console.log("categoryName :", categoryName)
    console.log("csrfToken :", csrfToken)

    //서버통신
    // const response = await fetch("http://52.78.250.255/chatbot_v1/", {
    const response = await fetch("https://kms-ai.net/chatbot_v1/", {
        method: "POST",
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            'X-CSRFToken': csrfToken
    ...
    if (response.ok) {
        ...
        //스트림 데이터 초기화
        const response2 = await fetch("https://kms-ai.net/chatbot_v1/get_message_stream_default/", {
            method: "POST",
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
                'X-CSRFToken': csrfToken
